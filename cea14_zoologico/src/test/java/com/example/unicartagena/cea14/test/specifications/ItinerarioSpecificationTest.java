package com.example.unicartagena.cea14.test.specifications;
...
public class ItinerarioSpecificationTest {
    @Test
    ...
    private BooleanAssert assertThat(boolean actual) {
        return new BooleanAssert(actual);
    }
    
    private static class BooleanAssert {
        private final boolean actual;
        BooleanAssert(boolean actual) { this.actual = actual; }
        void isTrue() { Assertions.assertTrue(actual); }
        void isFalse() { Assertions.assertFalse(actual); }
    }
}
